...
const CabinCard: React.FC<CabinCardProps> = ({ cabinInfo, ...props }) => {
  ...
  return (
      <div className="relative w-full flex justify-center">
        ...
        <div className={`absolute top-0 flex flex-col gap-3 items-start justify-center pl-10 pr-16`}
        ...
        <div>
          ...
          <p className="font-NeulisNeue-Bold text-[clamp(1rem,1.35vw,3rem)] text-charcoalFogDark"> Cabin Leaders</p>
        <div
            className="
              w-1/2 h-auto
              gap-4 flex flex-row">
