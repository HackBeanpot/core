      ...
      {isDesktop && (
        <div className="relative w-[50%] h-[400px] -top-4">
          <Circle
            title={"18"}
            subtitle={"workshops and activities"}
            className="absolute top-8 right-12 scale-90"
          />
          <Circle
            title={"41"}
            subtitle={"different tech tools used across different projects"}
            className="absolute top-28 right-64"
            circleScaling="scale-150"
          />
          <Circle
            title={"33"}
            subtitle={"project submissions"}
            className="absolute bottom-8 right-12 scale-90"
          />
          <Circle
            title={"36"}
            subtitle={"total hours of hacking"}
          ...
          <Circle
            title={"780"}
            subtitle={"applicants"}
            className="absolute bottom-14 left-64 scale-90"
          />
          <Circle
            title={"159"}
            subtitle={"hackers"}
            className="absolute top-10 left-28"
            circleScaling="scale-75"
          />
          <Circle
            title={"45%"}
            subtitle={"female/non-binary hackers"}
