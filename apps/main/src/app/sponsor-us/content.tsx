...
const SponsorUsContent = () => {
  ...
  const bgStyles = clsx("w-full relative z-0", isDesktop && "h-[70%]");
    ...
    <>
      ...
      <div className={bgStyles}>
        ...
        <div className="flex flex-col space-y-80 items-center justify-center mt-44">
          ...
          <RecruitmentBenefits className="z-10 scale-125"/>
          <SponsorTestimonialSection className="z-10"/>
          <SponsorTile 
            ...
            content={
              <div>
                <ul className="list-disc list-inside indent-6">
                  <li>Hacker resumes (filtered by career interests or experience)</li>
                  <li>Sponsoring a company specific prize</li>
                  <li>Onsite interviews</li>
                  <li>A spot in our career fair</li>
                  <li>Promotion on our newsletter & social medias (reach of 4,000 students)</li>
                  <li>Product demo</li>
                </ul>
                <p className="mt-6">Additionally, we provide the flexibility to create your own perk or package. Let us know your ideas and package choice at sponsorship@hackbeanpot.com. Our team will work with you to answer any questions and guide you through the next steps in becoming a HackBeanpot 2025 sponsor!</p>
              </div>
            } 
            className="z-10"
          />
            ...
            content={
              <div>
                <div className="relative grid grid-cols-3 grid-flow-dense ml-24 mt-10">
                  <div className="scale-150 ml-8 mt-1"><img src="/sponsor-logos/google.svg" alt="Google logo" /></div>
                  <div className="scale-150 ml-7"><img src="/sponsor-logos/datadog.svg" alt="Datadog logo" /></div>
                  <div className="scale-150 mt-2"><img src="/sponsor-logos/simplisafe.svg" alt="Simplisafe logo" /></div>
                  <div className="col-span-2 scale-150 ml-10"><img src="/sponsor-logos/meta.svg" alt="Meta logo" /></div>
                  <div className="scale-150"><img src="/sponsor-logos/woodmack.svg" alt="Wood Mackenzie logo" /></div>
                  <div className="scale-125 mt-2 ml-4"><img src="/sponsor-logos/upstatement.svg" alt="Upstatement logo" /></div>
                  <div className="scale-125 ml-3"><img src="/sponsor-logos/yelp.svg" alt="Yelp logo" /></div>
                  <div className="mt-8 scale-150"><img src="/sponsor-logos/vmware.svg" alt="Vmware logo" /></div>
                  <div><img src="/sponsor-logos/cargurus.svg" alt="Cargurus logo" /></div>
                  <div className="ml-10 scale-150"><img src="/sponsor-logos/toast.svg" alt="Toast logo" /></div>
                </div>
                <p className="mt-10 ml-6 font-medium text-lg" style={{ "fontStyle": "italic"}}>Due to HackBeanpot&apos;s status as a 501c3 nonprofit organization, all sponsorship package purchases are considered tax deductible.</p>
              </div>
              } 
              className="z-10" 
          />
