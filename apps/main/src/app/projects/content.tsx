    ...
    <div className="mt-[5%] mr-[5%] ml-[5%]">
      ...
      <div className="flex justify-center items-center flex-col font-GT-Walsheim-Regular bg-[#FFF8EF] p-10 rounded-3xl mr-[2rem] ml-[2rem] drop-shadow-[0_8px_0px_rgba(0,0,0,.1)]">
        <div className="flex justify-center items-center flex-col">
          <h3 className="text-center text-3xl mb-[1rem] font-bold">Interested in seeing more Past Hacker Projects?</h3>
          <p className="text-center text-2xl mb-[1.75rem]">Check out the HackBeanpot Archive!</p>
        </div>
        <a href="" className="text-center text-2xl text-[#FFFFFF] bg-[#00877F] p-5 pr-10 pl-10 rounded-full hover:scale-90 duration-1000">
          <p>View Archive</p>
        </a>
      </div>
    </div>
