...
function Project({
  ...
  `}
    ...
    >
      <div className="flex flex-row justify-center max-h-[485px] max-w-[400px] pt-[3rem] pb-[3rem] pr-[5rem] overflow-hidden">
        <div className="">
        ...
        <div className="max-w-40 mb-5 ml-10">
          ...
          <p className="text-[#918E89] mb-2 mt-3 text-l font-GT-Walsheim-Regular pb-1">
            {members}
          </p>
          <p className="inline-block w-full text-[#333333] text-sm font-GT-Walsheim-Regular hyphens-auto text-ellipsis pt-1">
            {description}
          </p>
        </div>
      </div>
